...
ast create_ast_node(ast_type k, char c, int num, char* str, ast l,ast m, ast r) {
    ast n;
...
ast ast_return(ast e) {
    return create_ast_node(RETURN, '\0', 0, NULL, e, NULL, NULL);
}
...
ast ast_id_list(ast l, ast r) {
    return create_ast_node(ID_LIST, '\0', 0, NULL, l, NULL, r);
}
